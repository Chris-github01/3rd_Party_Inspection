/*
  # Fix ORDER BY in get_executive_summary_data

  Fix SQL error where ORDER BY dp.pin_number is outside jsonb_agg aggregate
  The ORDER BY clause must be inside jsonb_agg() for it to work correctly
*/
