      ...
      <div className="p-8">
        <div className="bg-white rounded-xl shadow-xl p-8">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Fire Protection Material Registry</h1>
              <p className="text-slate-600 mt-1">Master library of fire protection coating materials and systems</p>
            </div>
          {isAdmin && (
        ...
        <div className="mb-6 space-y-4">
          ...
          >
            ...
            Advanced Filters
            {showFilters && <span className="text-xs text-slate-500">(Active)</span>}
          </button>
          ...
          {showFilters && (
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">External Use</label>
                  <select
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-700 uppercase">Manufacturer</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-700 uppercase">Product Name</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-700 uppercase">Type</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-700 uppercase">Application</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-700 uppercase">Fire Scenario</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-700 uppercase">Thickness Unit</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-slate-700 uppercase">Temp Range</th>
                    {isAdmin && (
                ...
                <tbody className="divide-y divide-slate-200">
                  {filteredMaterials.map((material) => (
                    <tr key={material.id} className="hover:bg-slate-50">
                      <td className="px-6 py-4 text-sm text-slate-900">{material.manufacturer}</td>
                      <td className="px-6 py-4">
                        <div className="text-sm font-medium text-slate-900">{material.product_name}</div>
                        {material.chemistry && (
                          <div className="text-xs text-slate-500">{material.chemistry}</div>
                        )}
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-sm text-slate-600">{material.thickness_unit}</td>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="space-y-6">
            <div className="border-b pb-4">
              <h3 className="font-semibold text-slate-900 mb-3">Core Identity</h3>
            ...
            <div className="border-b pb-4">
              <h3 className="font-semibold text-slate-900 mb-3">Classification</h3>
              <div className="grid grid-cols-3 gap-4">
                <div>
