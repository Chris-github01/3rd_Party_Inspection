    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <Image className={`w-6 h-6 ${data.drawingMode === 'with_drawings' ? 'text-primary-400' : 'text-slate-400'}`} />
              <h4 className="font-semibold text-white">With Drawings</h4>
            </div>
        ...
        >
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <FileText className={`w-6 h-6 ${data.drawingMode === 'without_drawings' ? 'text-primary-400' : 'text-slate-400'}`} />
              <h4 className="font-semibold text-white">Without Drawings</h4>
            </div>
            <p className="text-sm text-slate-300">
      ...
      {showHelp && (
        <div className="bg-slate-800 border border-slate-700 rounded-lg p-4">
          <h5 className="font-semibold text-white mb-2">Drawing Mode Guide</h5>
